        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        validators=[
                            django.core.validators.MinLengthValidator(10000, message='Product description is too short')
                        ],
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default='old',
                        help_text='Indicates the condition of the product. Select `New` for new items and `Old` for used ones.',
                        max_length=20,
                        verbose_name='Status',
                    ),
                ),
