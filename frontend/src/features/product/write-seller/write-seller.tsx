...
export const WriteSeller: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className={className}>
      <button className='relative flex h-[53px] w-[238px] min-w-full items-center justify-center rounded-[60px] bg-primary-900 text-base/4 text-gray-50 transition-colors duration-300 hover:bg-primary-500 active:bg-primary-600 active:duration-0 md:min-w-[238px]'>
