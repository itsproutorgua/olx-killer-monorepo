...
export const AboutUsBanner = () => {
  ...
  return (
    <div className='flex max-h-[329px] min-h-[158px] w-full max-w-[305px] items-end justify-between rounded-[15px] border border-border/60 bg-primary-100 px-[20px] pb-[19px] pt-[20px]'>
