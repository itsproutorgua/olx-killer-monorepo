    ...
    <div className='flex flex-col xl:flex-row'>
      {tabs.map(tab => (
        <button
          ...
          className={`flex items-center justify-between border-b-[1px] px-0 py-[14px] text-start xl:px-[35px] xl:py-[10px] xl:pt-0 xl:text-center xl:text-sm xl:font-medium ${
            activeTab === tab.id
              ? 'xl:border-b-[3px] xl:border-primary-900 xl:text-primary-900'
              : 'hover:text-primary-500 xl:border-b-[1px] xl:border-gray-200 xl:pb-3 xl:text-gray-500'
          }`}
        >
